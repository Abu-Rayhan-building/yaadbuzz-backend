...
import edu.sharif.math.yaadbuzz.config.audit.AuditEventConverter;
import edu.sharif.math.yaadbuzz.domain.PersistentAuditEvent;
...
import static edu.sharif.math.yaadbuzz.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
