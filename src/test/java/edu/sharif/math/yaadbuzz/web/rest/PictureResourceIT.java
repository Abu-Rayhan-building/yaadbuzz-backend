...
class PictureResourceIT {
    ...
    public static Picture createEntity(EntityManager em) {
        Picture picture = new Picture().image(DEFAULT_IMAGE).imageContentType(DEFAULT_IMAGE_CONTENT_TYPE);
        return picture;
    }
    ...
    public static Picture createUpdatedEntity(EntityManager em) {
        Picture picture = new Picture().image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
        return picture;
    }
    ...
    void createPicture() throws Exception {
        ...
        restPictureMockMvc
            .perform(post("/api/pictures").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(pictureDTO)))
    ...
    void getAllPictures() throws Exception {
        ...
        restPictureMockMvc
            .perform(get("/api/pictures?sort=id,desc"))
    ...
    void getNonExistingPicture() throws Exception {
        // Get the picture
        restPictureMockMvc.perform(get("/api/pictures/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    void updatePicture() throws Exception {
        ...
        updatedPicture.image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
        PictureDTO pictureDTO = pictureMapper.toDto(updatedPicture);

        restPictureMockMvc
            .perform(put("/api/pictures").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(pictureDTO)))
            .andExpect(status().isOk());
    ...
    void fullUpdatePictureWithPatch() throws Exception {
        ...
        partialUpdatedPicture.image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
    ...
    void deletePicture() throws Exception {
        ...
        // Delete the picture
        restPictureMockMvc
            .perform(delete("/api/pictures/{id}", picture.getId()).accept(MediaType.APPLICATION_JSON))
