...
import edu.sharif.math.yaadbuzz.security.*;
import edu.sharif.math.yaadbuzz.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	// .addFilterAfter(new EntityAutorityFilter(),BasicAuthenticationFilter.class)
	// @formatter:on
    }
