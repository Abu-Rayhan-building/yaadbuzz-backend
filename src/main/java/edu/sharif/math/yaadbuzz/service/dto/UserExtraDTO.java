...
public class UserExtraDTO implements Serializable {
    ...
    private UserPerDepartmentDTO defaultUserPerDepartment;
    ...
    public UserPerDepartmentDTO getDefaultUserPerDepartment() {
        return defaultUserPerDepartment;
    }

    public void setDefaultUserPerDepartment(UserPerDepartmentDTO defaultUserPerDepartment) {
    ...
    public String toString() {
        return "UserExtraDTO{" +
            ...
            ", phone='" + getPhone() + "'" +
            ", user=" + getUser() +
            ", defaultUserPerDepartment=" + getDefaultUserPerDepartment() +
            "}";
    }
}
