...
public class PictureNotCrudResource {
    ...
    public static ResponseEntity<Resource> createReponse(final Resource file,
	...
	if (this.commentService.currentuserHasGetAccess(memId,
		comId) == false) {
    ...
    private ResponseEntity<?> handleStorageFileNotFound(
