...
import edu.sharif.math.yaadmaan.security.*;
import edu.sharif.math.yaadmaan.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	web.ignoring().antMatchers(HttpMethod.OPTIONS, "/**")
		...
		.antMatchers("/content/**").antMatchers("/h2-console/**")
	...
	http.csrf().disable()
		...
		.and()
		.addFilterAfter(new EntityAutorityFilter(),
