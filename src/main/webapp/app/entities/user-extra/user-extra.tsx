  ...
  return (
    <div>
      <h2 id="user-extra-heading" data-cy="UserExtraHeading">
        <Translate contentKey="yaadbuzzApp.userExtra.home.title">User Extras</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="yaadbuzzApp.userExtra.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="yaadbuzzApp.userExtra.home.createLabel">Create new User Extra</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userExtraList && userExtraList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('phone')}>
                  <Translate contentKey="yaadbuzzApp.userExtra.phone">Phone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="yaadbuzzApp.userExtra.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {userExtraList.map((userExtra, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {userExtra.defaultUserPerDepartment ? (
                      <Link to={`user-per-department/${userExtra.defaultUserPerDepartment.id}`}>
                        {userExtra.defaultUserPerDepartment.id}
                      </Link>
                    ) : (
                      ''
                    )}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="yaadbuzzApp.userExtra.home.notFound">No User Extras found</Translate>
            </div>
          )
        )}
      </div>
