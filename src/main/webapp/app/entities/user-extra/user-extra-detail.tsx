    ...
    <Row>
      <Col md="8">
        <h2 data-cy="userExtraDetailsHeading">
          <Translate contentKey="yaadbuzzApp.userExtra.detail.title">UserExtra</Translate> [<strong>{userExtraEntity.id}</strong>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{userExtraEntity.defaultUserPerDepartment ? userExtraEntity.defaultUserPerDepartment.id : ''}</dd>
        </dl>
