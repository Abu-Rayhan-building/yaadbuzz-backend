...
export const TopicVoteDeleteDialog = (props: ITopicVoteDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="topicVoteDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-topicVote" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
