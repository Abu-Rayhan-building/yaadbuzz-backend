...
import { getEntities, reset } from './user-per-department.reducer';
import { IUserPerDepartment } from 'app/shared/model/user-per-department.model';
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';
import { ITEMS_PER_PAGE } from 'app/shared/util/pagination.constants';
import { overridePaginationStateWithQueryParams } from 'app/shared/util/entity-utils';

export interface IUserPerDepartmentProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export const UserPerDepartment = (props: IUserPerDepartmentProps) => {
    ...
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          ...
          initialLoad={false}
        >
          {userPerDepartmentList && userPerDepartmentList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
...
const mapStateToProps = ({ userPerDepartment }: IRootState) => ({
  userPerDepartmentList: userPerDepartment.entities,
  loading: userPerDepartment.loading,
  totalItems: userPerDepartment.totalItems,
  links: userPerDepartment.links,
  entity: userPerDepartment.entity,
...
export default connect(mapStateToProps, mapDispatchToProps)(UserPerDepartment);
